...
public class Login {
	private static String url = "http://localhost:8080/AutomateWebApp1/index.jsp";
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Shwetha", "shwetha@gmail.com", "shwe");// get login data
		addDetailToRegisterForm(driver, "shwetha@gmail.com", "shwe", "shwe");// get register data
