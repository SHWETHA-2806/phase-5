...
public class Testing {
	private static String url = "http://localhost:8080/AutomateWebApp2/index.jsp";
	...
	private void addDetailsToLoginForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"fname\"]")).sendKeys("Shwetha");
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("");
		driver.findElement(By.xpath("//*[@id=\"pass\"]")).sendKeys("shwe");
	...
	private void addDetailToRegisterForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("Shwetha@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"psw\"]")).sendKeys("shwe");
		driver.findElement(By.xpath("//*[@id=\"psw-repeat\"]")).sendKeys("shwe");
